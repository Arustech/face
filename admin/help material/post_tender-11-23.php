                        ...
                        <div class="widget box">
                            ...
                            <div class="widget-content">
								...
								<div class="form-group">
                                        ...
                                        <div class="col-md-10 input-width-large">
                                            <input type="text" class="form-control required" id="spinner-default" name="tender_company" value="<?=$tender_company?>"/>
                                        </div>
                                </div>
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
                                            <textarea class="auto form-control required" name="tender_desc" cols="5" rows="3" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 87px;"><?=$tender_desc?></textarea>
                                        </div>
									</div>	
								...
								<div class="form-group">
                                        ...
                                        <div class="col-md-10 input-width-large">
                                            <input type="text" class="form-control" id="spinner-default" name="tender_budget" placeholder="Amount in QR. Or US Dollar" value="<?=$tender_budget?>"/>
                                        </div>
                                </div>
								...
								<div class="form-group">
                                        ...
                                        <div class="col-md-10 input-width-large">
                                            <input type="text" class="form-control" id="spinner-default" name="tender_bond" placeholder="Amount in QR. Or US Dollar" value="<?=$tender_bond?>"/>
                                        </div>
                                </div>
								<div class="form-group">
                                        <label class="col-md-2 control-label">Tender fees:</label>
                                        <div class="col-md-10 input-width-large">
                                            <input type="text" class="form-control" id="spinner-default" name="tender_fees" placeholder="Amount in QR. Or US Dollar" value="<?=$tender_fees?>"/>
                                        </div>
                                </div>	
								<div class="form-group">
