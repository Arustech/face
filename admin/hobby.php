            ...
            <div class="container">
                    ...
                    <div class="col-md-12" id="add_cat">
						...
						?>
                            <div class="widget-header">
                                <h4><i class="icon-reorder"></i>Hobbies List</h4> 
                                ...
                                <form class="form-horizontal row-border" id="list_type" action="#" method="post" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-10 input-width-large">
                                            <input type="text" name="hobby_name" value="<?=$hobby_name;?>"id="spinner-default" class="form-control required">
                                        </div>
                ...
                <div class="row" id="list">
                    <div class="col-md-12">
                        <div class="widget box">
                            <div class="widget-header">
                                <h4><i class="icon-reorder"></i>Manage Hobbies</h4> 
                                <div class="toolbar no-padding">
                                    <div class="btn-group"> <span class="btn btn-xs widget-collapse"><i class="icon-angle-down"></i></span> 
                                    </div>
                                </div>
									...
									foreach($rows as $row)
									  ...
									  ?>
                                        <tr>
										   ...
										   <a href="?mod=edit&id=<?=$row['hobby_id']?>" class="btn btn-xs bs-tooltip" title="Edit">
										   <i class="icon-pencil"></i>
										   </a> 
										   <a href="?mod=trash&id=<?=$row['hobby_id']?>" class="btn btn-xs bs-tooltip" title="Delete">
