            ...
            method_1: function (options) {
                ...
                return this.each(function () {
                    ...
                    if (after_element) {
                        ...
                        _this.next('.ls_main').find('.ls_inner').css({
                            'background-color': color_option_2
                        });
                    } else {
                        ...
                        _this.find('.ls_main').css({
                            'margin-top': (_this.find('.ls_outer').height() - _this.find('.ls_main').outerHeight()) / 2
                        });
                        var time_duration = setTimeout(ls_effect, animation_speed);
                        _this.find('.ls_inner').css({
                            'background-color': color_option_2
                        });
                    }
                    var i = 0;
            ...
            method_2: function (options) {
                ...
                return this.each(function () {
                    ...
                    function ls_effect() {
                        if (zoom_effect[0]) {
                            _this.find('.ls_inner').css({
                                'background-color': color_option_1,
                                'height': main_height
                            });
                            _this.find('.ls_inner').eq(i).css({
                                'background-color': color_option_2,
                                'height': main_height + zoom_effect[1]
                            });
                        } else {
                            _this.find('.ls_inner').css({
                                'background-color': color_option_1
                    ...
                    function ls_effect_af() {
                        if (zoom_effect[0]) {
                            ...
                            _this.next('.ls_main').find('.ls_inner').eq(j).css({
                                'background-color': color_option_2,
                                'height': main_height + zoom_effect[1]
                            });
                        } else {
                    ...
                    function ls_effect() {
                        if (zoom_effect[0]) {
                            _this.find('.ls_inner').css({
                                ...
                                'font-size': zoom_effect[1]
                            });
                            _this.find('.ls_inner').eq(i).css({
                                'color': color_option_2,
                                'font-size': zoom_effect[2]
                            });
                        } else {
                            _this.find('.ls_inner').css({
                                'color': color_option_1
                ...
                return this.each(function () {
                    ...
                    function ls_effect_af() {
                        if (reverse_animation) {
                            ...
                            _this.next('.ls_main').find('.ls_inner.' + l + '').css({
                                'background-color': color_option_2
                            });
                        } else {
                            _this.next('.ls_main').find('.ls_inner').css({
                            ...
                            _this.next('.ls_main').find('.ls_inner.' + m + '').css({
                                'background-color': color_option_2
                            });
                        }
                        time_duration_af = setTimeout(ls_effect_af, animation_speed);
                ...
                return this.each(function () {
                        ...
                        if (animation_effect == 'rotate') {
                            ...
                            if (i % 2 == 0) {
                                if (animation_effect == 'round') {
                                    _this.find('.ls_inner').eq(0).css({
                                        'background-color': color_option_2
                                    });
                                    _this.find('.ls_inner').eq(1).css({
                                        'background-color': color_option_2
                                    });
                                    _this.find('.ls_inner').eq(2).css({
                                        'background-color': color_option_2
                                    });
                                    _this.find('.ls_inner').eq(3).css({
                                        'background-color': color_option_1
                                    });
                                    _this.find('.ls_inner').eq(5).css({
                                        'background-color': color_option_2
                                    });
                                    _this.find('.ls_inner').eq(6).css({
                                        'background-color': color_option_1
                                    });
                                    _this.find('.ls_inner').eq(7).css({
                                        'background-color': color_option_1
                                    });
                                    _this.find('.ls_inner').eq(8).css({
                                        'background-color': color_option_1
                                    });
                                } else if (animation_effect == 'cross') {
                                    _this.find('.ls_inner').eq(4).css({
                                        'background-color': color_option_2
                                    });
                                    _this.find('.ls_inner').eq(0).css({
                                        'background-color': color_option_1
                                    ...
                                    _this.find('.ls_inner:even').css({
                                        'background-color': color_option_1
                                    });
                                    _this.find('.ls_inner:odd').css({
                                        'background-color': color_option_2
                                    });
                                }
                            } else {
                    ...
                    function ls_effect_af() {
                        if (animation_effect == 'rotate') {
                            ...
                            if (j % 2 == 0) {
                                if (animation_effect == 'round') {
                                    _this.next('.ls_main').find('.ls_inner').eq(0).css({
                                        'background-color': color_option_2
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(1).css({
                                        'background-color': color_option_2
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(2).css({
                                        'background-color': color_option_2
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(3).css({
                                        'background-color': color_option_1
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(5).css({
                                        'background-color': color_option_2
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(6).css({
                                        'background-color': color_option_1
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(7).css({
                                        'background-color': color_option_1
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(8).css({
                                        'background-color': color_option_1
                                    });
                                } else if (animation_effect == 'cross') {
                                    _this.next('.ls_main').find('.ls_inner').eq(4).css({
                                        'background-color': color_option_2
                                    });
                                    _this.next('.ls_main').find('.ls_inner').eq(0).css({
                                        'background-color': color_option_1
                                    ...
                                    _this.next('.ls_main').find('.ls_inner:even').css({
                                        'background-color': color_option_1
                                    });
                                    _this.next('.ls_main').find('.ls_inner:odd').css({
                                        'background-color': color_option_2
                                    });
                                }
                            } else {
